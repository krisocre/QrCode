import { adjustCustomer, listCustomers } from '../../admin-domain.js'
import { requireSupabaseActor } from '../../auth.js'
import { badRequest } from '../../errors.js'
import { api, body, header, method, ok, query } from '../../http.js'
import { integerField, record, safeSearch, stringField, uuid } from '../../validation.js'
