import { updateProgram } from '../../admin-domain.js'
import { requireSupabaseActor } from '../../auth.js'
import { tenantById } from '../../domain.js'
import { tenantView } from '../../presenters.js'
import { api, body, method, ok } from '../../http.js'
import { enumField, integerField, numberField, openingHoursField, record, stringField } from '../../validation.js'
