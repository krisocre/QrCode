import { requireCustomerActor, requireSupabaseUser } from '../../auth.js'
import { customerBundle, updateCustomerProfile } from '../../domain.js'
import { ApiError } from '../../errors.js'
import { api, body, header, method, ok } from '../../http.js'
import { db } from '../../supabase.js'
import type { Actor, MembershipRow } from '../../types.js'
